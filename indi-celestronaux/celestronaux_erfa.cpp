...
static std::unique_ptr<CelestronAUXErfa> telescope_caux(new CelestronAUXErfa());
...
///
/////////////////////////////////////////////////////////////////////////////////////
CelestronAUXErfa::CelestronAUXErfa()
    : GI(this), FI(this),
      ScopeStatus(IDLE),
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::Handshake()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::Disconnect()
{
    Abort();
...
///
/////////////////////////////////////////////////////////////////////////////////////
const char *CelestronAUXErfa::getDefaultName()
{
    return "Celestron AUX ERFA";
}

/////////////////////////////////////////////////////////////////////////////
///
/////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::ISGetProperties(const char *dev)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::initProperties()
{
    ...
    // Update Rate
    UpdateRateNP[0].fill("UPDATE_RATE", "Tracking Update (ms)", "%.f", 100, 5000, 100, 1000);
    UpdateRateNP.fill(getDeviceName(), "UPDATE_RATE", "Update Rate", MOUNTINFO_TAB, IP_RW, 60, IPS_IDLE);
    UpdateRateNP.load();

    // Set default polling period to 1Hz
    SetTimer(UpdateRateNP[0].getValue());
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::formatModelString(char *s, int n, uint16_t model)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::formatVersionString(char *s, int n, uint8_t *verBuf)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::updateProperties()
{
    INDI::Telescope::updateProperties();

    updateErfaProperties(isConnected());
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::saveConfigItems(FILE *fp)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::ISSnoopDevice(XMLEle *root)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::ISNewBLOB(const char *dev, const char *name, int sizes[], int blobsizes[], char *blobs[],
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::ISNewNumber(const char *dev, const char *name, double values[], char *names[], int n)
{
    ...
    if (strcmp(dev, getDeviceName()) == 0)
    {
        // ERFA atmospheric properties
        if (handleErfaNumber(name, values, names, n))
            return true;
        ...
        if (UpdateRateNP.isNameMatch(name))
        {
            ...
            double newDt = UpdateRateNP[0].getValue() / 1000.0;
            if (m_az_pid_tuner) m_az_pid_tuner->setDt(newDt);
            if (m_al_pid_tuner) m_al_pid_tuner->setDt(newDt);

            // Re-initialize PID controllers with new dt
            {
                double kp, ki, kd;
                kp = Axis1PIDNP[Propotional].getValue();
                ki = Axis1PIDNP[Integral].getValue();
                kd = Axis1PIDNP[Derivative].getValue();
                m_Controllers[AXIS_AZ].reset(new PID(newDt, 10000, -10000, kp, ki, kd));
                m_Controllers[AXIS_AZ]->setIntegratorLimits(-10000, 10000);

                kp = Axis2PIDNP[Propotional].getValue();
                ki = Axis2PIDNP[Integral].getValue();
                kd = Axis2PIDNP[Derivative].getValue();
                m_Controllers[AXIS_ALT].reset(new PID(newDt, 10000, -10000, kp, ki, kd));
        ...
        if (HorizontalCoordsNP.isNameMatch(name))
        {
            ...
            erfaHorizToEq(celestialAzAlt.altitude, celestialAzAlt.azimuth, currentJD(),
                          &celestialEquatorial.rightascension, &celestialEquatorial.declination);
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::ISNewSwitch(const char *dev, const char *name, ISState *states, char *names[], int n)
{
    if (strcmp(dev, getDeviceName()) == 0)
    {
        // ERFA refraction control
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::ISNewText(const char *dev, const char *name, char *texts[], char *names[], int n)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::SetCurrentPark()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::SetDefaultPark()
{
    SetAxis1Park(m_MountType == EQ_GEM ? GEM_HOME : 0);
    SetAxis2Park(m_MountType == EQ_GEM ? GEM_HOME : 0);
    return true;
...
///
/////////////////////////////////////////////////////////////////////////////////////
INDI::IHorizontalCoordinates CelestronAUXErfa::AltAzFromRaDec(double ra, double dec, double ts)
{
    ...
    else
    {
        ...
        erfaEqToHoriz(EquatorialCoordinates.rightascension, EquatorialCoordinates.declination,
                      currentJD(), &AltAz.altitude, &AltAz.azimuth);
...
///
/////////////////////////////////////////////////////////////////////////////////////
double CelestronAUXErfa::getNorthAz()
{
    ...
    if (!GetDatabaseReferencePosition(location))
        ...
        northAz = DegreesToAzimuth(AltAzFromRaDec(localSiderealTime(currentJD(), m_Location.longitude), 0., 0.).azimuth);
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::syncCoordWrapPosition()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::MoveNS(INDI_DIR_NS dir, TelescopeMotionCommand command)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::MoveWE(INDI_DIR_WE dir, TelescopeMotionCommand command)
{
    int rate = SlewRateSP.findOnSwitchIndex() + 1;
...
///
/////////////////////////////////////////////////////////////////////////////////////
IPState CelestronAUXErfa::GuideNorth(uint32_t ms)
{
    if (m_MountType == ALT_AZ)
    {
...
IPState CelestronAUXErfa::GuideSouth(uint32_t ms)
{
    if (m_MountType == ALT_AZ)
    {
        guideAltAzDecomposed(-GuideRateNP[AXIS_ALT].getValue(), 0.0, ms);
...
IPState CelestronAUXErfa::GuideEast(uint32_t ms)
{
    if (m_MountType == ALT_AZ)
    {
...
IPState CelestronAUXErfa::GuideWest(uint32_t ms)
{
    if (m_MountType == ALT_AZ)
    {
        guideAltAzDecomposed(0.0, GuideRateNP[AXIS_AZ].getValue(), ms);
...
bool CelestronAUXErfa::guidePulse(INDI_EQ_AXIS axis, uint32_t ms, int8_t rate)
{
...
bool CelestronAUXErfa::guidePulsePhysical(INDI_EQ_AXIS axis, uint32_t ms, int8_t rate)
{
    uint8_t ticks = std::min(255u, ms / 10);
    AUXBuffer data(2);
    data[0] = rate;
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::AbortFocuser()
{
...
IPState CelestronAUXErfa::MoveRelFocuser(FocusDirection dir, uint32_t ticks)
{
...
IPState CelestronAUXErfa::MoveAbsFocuser(uint32_t targetTicks)
{
    if (!m_FocusEnabled)
    {
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::resetTracking()
{
    //    getEncoder(AXIS_AZ);
    //    getEncoder(AXIS_ALT);
    ...
    double dt = UpdateRateNP[0].getValue() / 1000.0;
    m_Controllers[AXIS_AZ].reset(new PID(dt, 10000, -10000, Axis1PIDNP[Propotional].getValue(),
                                         Axis1PIDNP[Derivative].getValue(), Axis1PIDNP[Integral].getValue()));
    m_Controllers[AXIS_AZ]->setIntegratorLimits(-10000, 10000);
    m_Controllers[AXIS_ALT].reset(new PID(dt, 10000, -10000, Axis2PIDNP[Propotional].getValue(),
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::isTrackingRequested()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::ReadScopeStatus()
{
    if (!isConnected())
        return false;
    ...
    if (std::abs(axis1 - EncoderNP[AXIS_AZ].getValue()) > 1 || std::abs(axis2 - EncoderNP[AXIS_ALT].getValue()) > 1)
    {
        ...
        {
            AngleNP[AXIS_RA].setValue(range360(range24(localSiderealTime(currentJD(), m_Location.longitude) -
    ...
    erfaEqToHoriz(m_SkyCurrentRADE.rightascension, m_SkyCurrentRADE.declination,
                  currentJD(), &celestialAzAlt.altitude, &celestialAzAlt.azimuth);

    char AzStr[32] = {0}, AltStr[32] = {0}, HAStr[32] = {0};
    fs_sexa(AzStr, celestialAzAlt.azimuth, 2, 3600);
    fs_sexa(AltStr, celestialAzAlt.altitude, 2, 3600);
    double HA = rangeHA(localSiderealTime(currentJD(), m_Location.longitude) - m_SkyCurrentRADE.rightascension);
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::EncodersToAltAz(INDI::IHorizontalCoordinates &coords)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::Goto(double ra, double dec)
{
    char RAStr[32] = {0}, DecStr[32] = {0};
    ...
    if (TransformCelestialToTelescope(ra, dec, 0.0, TDV))
    {
        ...
        if (m_MountType == ALT_AZ)
        {
            ...
            erfaHorizToEq(MountAltAz.altitude, MountAltAz.azimuth, currentJD(),
                          &MountRADE.rightascension, &MountRADE.declination);
        }
    ...
    else
    {
        ...
        {
            INDI::IHorizontalCoordinates MountAltAz { 0, 0 };
            erfaEqToHoriz(MountRADE.rightascension, MountRADE.declination, currentJD(),
                          &MountAltAz.altitude, &MountAltAz.azimuth);
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::Sync(double ra, double dec)
{
    ...
    NewEntry.ObservationJulianDate = currentJD();
...
///
//////////////////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::mountToSkyCoords()
{
    ...
    if (m_MountType == ALT_AZ)
    {
        ...
        if (!TransformTelescopeToCelestial(TDV, RightAscension, Declination))
        {
            ...
            erfaHorizToEq(AltAz.altitude, AltAz.azimuth, currentJD(),
                          &EquatorialCoordinates.rightascension, &EquatorialCoordinates.declination);
...
bool CelestronAUXErfa::enforceSlewLimits()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::TimerHit()
{
            ...
            else if (m_MountType == ALT_AZ)
            {
                ...
                auto getCoords = [&](double JD, INDI::IHorizontalCoordinates & coords)
                {
                    ...
                    if (!TransformCelestialToTelescope(m_SkyTrackingTarget.rightascension, m_SkyTrackingTarget.declination, JD - JDnow, TDV))
                    {
                        ...
                        erfaEqToHoriz(Equat.rightascension, Equat.declination, JD, &coords.altitude, &coords.azimuth);
                    }
                    else
                    {
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::updateLocation(double latitude, double longitude, double elevation)
{
...
/// 0 to 360 degrees
/////////////////////////////////////////////////////////////////////////////////////
double CelestronAUXErfa::EncodersToDegrees(uint32_t steps)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
uint32_t CelestronAUXErfa::DegreesToEncoders(double degree)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
double CelestronAUXErfa::DegreesToAzimuth(double degree)
{
    if (isNorthHemisphere())
        return degree;
    else
...
///
/////////////////////////////////////////////////////////////////////////////////////
double CelestronAUXErfa::AzimuthToDegrees(double degree)
{
    if (isNorthHemisphere())
        return degree;
    else
...
/// 0 to 24 hours
/////////////////////////////////////////////////////////////////////////////////////
double CelestronAUXErfa::EncodersToHours(uint32_t steps)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
uint32_t CelestronAUXErfa::HoursToEncoders(double hour)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::EncodersToRADE(INDI::IEquatorialCoordinates &coords, TelescopePierSide &pierSide)
{
    double de = 0, ha = 0;
    ...
    double lst = localSiderealTime(currentJD(), LocationNP[LOCATION_LONGITUDE].getValue());
...
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::RADEToEncoders(const INDI::IEquatorialCoordinates &coords, uint32_t &haEncoder, uint32_t &deEncoder)
{
    double lst = localSiderealTime(currentJD(), LocationNP[LOCATION_LONGITUDE].getValue());
...
/// -90 to +90
/////////////////////////////////////////////////////////////////////////////////////
double CelestronAUXErfa::EncodersToDE(uint32_t steps, TelescopePierSide pierSide)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
double CelestronAUXErfa::DEToEncoders(double de)
{
    double degrees = 0;
    if (m_MountType == EQ_FORK)
        degrees = de;
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::isSlewing()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::slewTo(INDI_HO_AXIS axis, uint32_t steps, bool fast)
{
    // Stop first.
    trackByRate(axis, 0);
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::slewByRate(INDI_HO_AXIS axis, int8_t rate)
{
    // Stop first.
    trackByRate(axis, 0);
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::goHome(INDI_HO_AXIS axis)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::isHomingDone(INDI_HO_AXIS axis)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::startupWithoutHC()
{
    AUXBuffer data(3);
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getModel(AUXTargets target)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getVersion(AUXTargets target)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getGuideRate(AUXTargets target)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::setGuideRate(AUXTargets target, uint8_t rate)
{
    AUXBuffer data(1);
    data[0] = rate;
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::getVersions()
{
    if (!m_isHandController)
    {
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getFocusLimits()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getFocusStatus()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getFocusPosition()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::focusTo(uint32_t steps)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::focusByRate(int8_t rate)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::setCordWrapEnabled(bool enable)
{
...
bool CelestronAUXErfa::getCordWrapEnabled()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::setCordWrapPosition(uint32_t steps)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
uint32_t CelestronAUXErfa::getCordWrapPosition()
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::stopAxis(INDI_HO_AXIS axis)
{
...
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::trackByRate(INDI_HO_AXIS axis, int32_t rate)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::trackByMode(INDI_HO_AXIS axis, uint8_t mode)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::SetTrackEnabled(bool enabled)
{
    if (enabled)
    {
        m_IsPipelinePrimed = false;
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::SetTrackRate(double raRate, double deRate)
{
...
///
/////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::SetTrackMode(uint8_t mode)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getStatus(INDI_HO_AXIS axis)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::getEncoder(INDI_HO_AXIS axis)
{
...
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::emulateGPS(AUXCommand &m)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::processResponse(AUXCommand &m)
{
    m.logResponse();
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::serialReadResponse(AUXCommand c)
{
    int n;
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::tcpReadResponse()
{
    int n, i;
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::readAUXResponse(AUXCommand c)
{
    if (getActiveConnection() == serialConnection)
...
///
/////////////////////////////////////////////////////////////////////////////////////
int CelestronAUXErfa::sendBuffer(AUXBuffer buf)
{
    if ( PortFD > 0 )
    {
        int n;
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::sendAUXCommand(AUXCommand &command)
{
    AUXBuffer buf;
    command.logCommand();
...
////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::setRTS(bool rts)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::waitCTS(float timeout)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::detectRTSCTS()
{
    setRTS(1);
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::detectHC(char *version, size_t size)
{
    AUXBuffer b;
    char buf[3];
...
///
/////////////////////////////////////////////////////////////////////////////////////
int CelestronAUXErfa::aux_tty_read(char *buf, int bufsiz, int timeout, int *n)
{
    int errcode;
...
///
/////////////////////////////////////////////////////////////////////////////////////
int CelestronAUXErfa::aux_tty_write(char *buf, int bufsiz, float timeout, int *n)
{
    int errcode, ne;
    char errmsg[MAXRBUF];
...
///
/////////////////////////////////////////////////////////////////////////////////////
bool CelestronAUXErfa::tty_set_speed(speed_t speed)
{
...
///
/////////////////////////////////////////////////////////////////////////////////////
void CelestronAUXErfa::hex_dump(char *buf, AUXBuffer data, size_t size)
{
...
void CelestronAUXErfa::guideAltAzDecomposed(double dNS, double dEW, uint32_t ms)
{
    ...
    double H      = rangeHA(localSiderealTime(currentJD(), m_Location.longitude) - m_SkyCurrentRADE.rightascension) * M_PI / 12.0;
